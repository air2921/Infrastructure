...
/// </remarks>
public abstract class OqsAlgorithm<TAlgorithm> : IDisposable where TAlgorithm : IOqsAlgorithmFormat, new()
{
    /// <summary>
    ...
    /// </remarks>
    protected TAlgorithm algorithmFormat;
    ...
    /// </remarks>
    private static readonly string _dllPath = Path.Join(Path.GetTempPath(), $"{nameof(OqsAlgorithm<TAlgorithm>)}-oqs.dll");
