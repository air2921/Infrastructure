...
public abstract class MongoDatabaseContext : IDisposable
{
    ...
    private static readonly Lazy<EntityException> _operationCancelledError = new(() => new EntityException("Operation was cancelled"));
    private static readonly Lazy<EntityException> _sessionAlreadyCreated = new(() => new EntityException("Session already created"));
    private static readonly Lazy<EntityException> _transactionNotStarted = new(() => new EntityException("Transaction is not started"));
