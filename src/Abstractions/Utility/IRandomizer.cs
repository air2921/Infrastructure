...
public interface IRandomizer
{
    ...
    /// </summary>
    /// <param name="count">The number of GUIDs to combine. The value must be between <see cref="Immutable.ValidationParameter.MinGuidCombineLength"/> and <see cref="Immutable.ValidationParameter.MaxGuidCombineLength"/>.</param>
    ...
    /// <exception cref="InvalidArgumentException">Thrown if the <paramref name="count"/> is outside the supported range, defined in <see cref="Immutable.ValidationParameter.MinGuidCombineLength"/> and <see cref="Immutable.ValidationParameter.MaxGuidCombineLength"/>.</exception>
    ...
    /// </summary>
    /// <param name="length">The length of the numeric code to generate. The value must be between <see cref="Immutable.ValidationParameter.MinCodeLength"/> and <see cref="Immutable.ValidationParameter.MaxCodeLength"/>.</param>
    /// <returns>A random numeric code as a string.</returns>
    /// <exception cref="InvalidArgumentException">Thrown if the <paramref name="length"/> is outside the supported range, defined in <see cref="Immutable.ValidationParameter.MinCodeLength"/> and <see cref="Immutable.ValidationParameter.MaxCodeLength"/>.</exception>
