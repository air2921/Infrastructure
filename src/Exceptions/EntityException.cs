...
/// ensuring that exceptions are thrown only when necessary.
/// </remarks>
/// <remarks>
/// Initializes a new instance of the <see cref="EntityException"/> class with a specified error message.
/// </remarks>
/// <param name="message">The error message that explains the reason for the exception.</param>
public class EntityException(string? message) : InfrastructureException(message)
{
    private static readonly HashSet<EntityException> _errors = [];
    ...
    public static void ThrowIf([DoesNotReturnIf(true)] bool condition, string message)
    {
        ...
        error = new EntityException(message);
        _errors.Add(error);
    ...
    /// <summary>
    /// Compares the current <see cref="EntityException"/> object with another object.
    /// Two <see cref="EntityException"/> objects are considered equal if they have the same message.
    /// </summary>
    ...
    {
        if (obj is not EntityException other)
            return false;
    ...
    /// <summary>
    /// Gets the hash code for the current <see cref="EntityException"/> object.
    /// The hash code is based on the exception's message.
    /// </summary>
    /// <returns>The hash code for the current <see cref="EntityException"/>.</returns>
