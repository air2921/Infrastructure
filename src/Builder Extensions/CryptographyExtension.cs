...
public static class CryptographyExtension
{
    ...
    ///     <item><description><see cref="ISigner"/> - Scoped service for signing data using the Dilithium algorithm.</description></item>
    /// </list>
    /// </remarks>
    public static IInfrastructureBuilder AddCryptography(this IInfrastructureBuilder builder)
    {
        ...
        builder.Services.AddScoped<ISigner, DilithiumSigner>();
